...
workers = 2    # change this line according to your company (adjust based on your server CPU count: 2*CPU+1)
...
worker_connections = 500   # change this line according to your company (adjust based on expected traffic)

# ========== TIMEOUTS ==========
timeout = 120          # change this line according to your company (adjust based on your longest request)
graceful_timeout = 30  # change this line according to your company (adjust based on your request patterns)
keepalive = 5

# ========== MEMORY MANAGEMENT ==========
max_requests = 1000        # change this line according to your company (adjust worker recycling frequency)
