...
if settings.DEBUG:
    ...
    r = DefaultRouter()
    r.register('apiviewset', views.DRFViewSet, basename='apiviewset')         # normal ViewSet — basename mandatory
    r.register('apimodelviewset', views.DRFModelViewSet, basename='apimodelviewset')  # ModelViewSet — basename optional
