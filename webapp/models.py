...
class contacus(models.Model):  # change this line according to your company (rename model to suit your project)
...
YEAR_CHOICES = [("1927", "1927"), ("1985", "1985"), ("2000", "2000"), ("2015", "2015")]  # change this line according to your company (update years relevant to your company history)


class aboutdetails(models.Model):  # change this line according to your company (rename/redesign this model for your about page content)
    title = models.CharField(max_length=264)
    slug = models.SlugField(max_length=264, unique=True)
    body = models.TextField()
    phase = models.CharField(max_length=20, choices=YEAR_CHOICES, default="1927")  # change this line according to your company
...
class wishdata(models.Model):  # change this line according to your company (replace with your own domain models)
    username = models.CharField(max_length=100)
    name = models.CharField(max_length=100)
    astrology_message = models.CharField(max_length=300)  # change this line according to your company
...
class author(models.Model):  # change this line according to your company (rename/redesign this model for your business domain)
...
class book( models.Model):  # change this line according to your company (rename/redesign this model for your business domain)
    title = models.CharField(max_length=200)
    author = models.ForeignKey(author, on_delete=models.CASCADE, related_name="books_by_author", to_field="authorname")
